...
describe('matchRoutes', function () {
  ...
  describe('an asynchronous JSX route config', function () {
    ...
    beforeEach(function () {
      getChildRoutes = function (location, callback) {
        setTimeout(function () {
          callback(null, React.createElement(Route, { path: ':userID' }));
        });
      };

      getIndexRoute = function (location, callback) {
        setTimeout(function () {
          callback(null, React.createElement(Route, { name: 'jsx' }));
        });
      };

      jsxRoutes = createRoutes([React.createElement(Route, { name: 'users',
        path: 'users',
    ...
    it('when getChildRoutes callback returns reactElements', function (done) {
      matchRoutes(jsxRoutes, createLocation('/users/5'), function (error, match) {
        expect(match).toExist();
        expect(match.routes.map(function (r) {
          return r.path;
  ...
  describe('invalid route configs', function () {
    ...
    describe('index route with path', function () {
      beforeEach(function () {
        invalidRoutes = createRoutes(React.createElement(
          Route,
          { path: '/' },
          React.createElement(IndexRoute, { path: 'foo' })
        ));
      });
